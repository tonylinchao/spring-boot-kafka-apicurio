 ...
 */
package com.hkt.btu.ruby.kafka.schema.avro;
...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7321637834050325041L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Event\",\"namespace\":\"com.hkt.btu.ruby.kafka.schema.avro\",\"doc\":\"Avro Schema for Event\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"description\",\"type\":\"string\"},{\"name\":\"createdOn\",\"type\":\"int\",\"logicalType\":\"timestamp-millis\"}]}");
   ...
   */
  public Event(java.lang.CharSequence name, java.lang.CharSequence description, java.lang.Integer createdOn) {
    this.name = name;
   ...
   */
  public static com.hkt.btu.ruby.kafka.schema.avro.Event.Builder newBuilder() {
    return new com.hkt.btu.ruby.kafka.schema.avro.Event.Builder();
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static com.hkt.btu.ruby.kafka.schema.avro.Event.Builder newBuilder(com.hkt.btu.ruby.kafka.schema.avro.Event.Builder other) {
    if (other == null) {
      return new com.hkt.btu.ruby.kafka.schema.avro.Event.Builder();
    } else {
      return new com.hkt.btu.ruby.kafka.schema.avro.Event.Builder(other);
    }
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static com.hkt.btu.ruby.kafka.schema.avro.Event.Builder newBuilder(com.hkt.btu.ruby.kafka.schema.avro.Event other) {
    if (other == null) {
      return new com.hkt.btu.ruby.kafka.schema.avro.Event.Builder();
    } else {
      return new com.hkt.btu.ruby.kafka.schema.avro.Event.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hkt.btu.ruby.kafka.schema.avro.Event.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hkt.btu.ruby.kafka.schema.avro.Event other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hkt.btu.ruby.kafka.schema.avro.Event.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hkt.btu.ruby.kafka.schema.avro.Event.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hkt.btu.ruby.kafka.schema.avro.Event.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hkt.btu.ruby.kafka.schema.avro.Event.Builder clearDescription() {
      description = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hkt.btu.ruby.kafka.schema.avro.Event.Builder setCreatedOn(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hkt.btu.ruby.kafka.schema.avro.Event.Builder clearCreatedOn() {
